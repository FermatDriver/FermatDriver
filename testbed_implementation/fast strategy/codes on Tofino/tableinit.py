...
'''fermat_host'''
fermat_host_conf=open(path+"fermat_host_conf1.txt")
...
'''fermat_host1'''
fermat_host_conf=open(path+"fermat_host_conf2.txt")

table = p4.Ingress.fermat_host
for t in fermat_host_conf:
    d=t.split()
    table.add_with_unicast_send1(ip_dst_addr=ip_address(d[0]), port=int(d[1]))
